...
<div class="col-md-8 mx-auto">
  <h3>Editar Pel·lícula</h3>

  <form method="POST" action="{{ route('web.pelicula.update', $movie->id) }}">
    @csrf
    @method('PUT')
    ...
    <div class="mb-3">
      ...
      <input id="any_estrena" name="any_estrena" type="number"
             ...
             value="{{ old('any_estrena', $movie->any_estrena) }}">
      @error('any_estrena')
        <div class="invalid-feedback">
    ...
    <div class="mb-3">
      ...
      <input id="duracio" name="duracio" type="number"
             ...
             value="{{ old('duracio', $movie->duracio) }}">
      @error('duracio')
        <div class="invalid-feedback">
    ...
    <div class="mb-3">
      ...
      <input id="valoracio" name="valoracio" type="number" step="0.1"
             ...
             value="{{ old('valoracio', $movie->valoracio) }}">
      @error('valoracio')
        <div class="invalid-feedback">
